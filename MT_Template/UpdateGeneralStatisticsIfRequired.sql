...
GO
GRANT VIEW DEFINITION ON [dbo].[UpdateGeneralStatisticsIfRequired] TO [MTS_DB_Dev]
GO
GRANT VIEW DEFINITION ON [dbo].[UpdateGeneralStatisticsIfRequired] TO [MTS_DB_Lite]
GO
