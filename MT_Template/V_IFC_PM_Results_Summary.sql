...
FROM dbo.T_Match_Making_Description MMD
     INNER JOIN dbo.T_FTICR_Analysis_Description FAD
       ON MMD.MD_Reference_Job = FAD.Job
     INNER JOIN dbo.T_MMD_State_Name MSN
       ON MMD.MD_State = MSN.MD_State
     INNER JOIN dbo.T_MMD_Type_Name MTN
       ON MMD.MD_Type = MTN.MD_Type
