...
GO
GRANT VIEW DEFINITION ON [dbo].[V_MS_Analysis_Jobs_and_Cell_Culture] TO [MTS_DB_Dev] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[V_MS_Analysis_Jobs_and_Cell_Culture] TO [MTS_DB_Lite] AS [dbo]
GO
