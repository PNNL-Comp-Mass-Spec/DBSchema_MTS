...
(
	...
	@PublicObjects varchar(1024) = 'T_Analysis_State_Name, T_FAD_State_Name, T_FPR_State_Name, T_FPR_Type_Name, T_FPR_UMC_Member_Type_Name, T_GANET_Update_Task_State_Name, T_General_Statistics, T_Log_Entries, T_MMD_State_Name, T_MMD_Type_Name, T_Peak_Matching_Defaults, T_Peak_Matching_NET_Value_Type_Name, T_Peak_Matching_Task_State_Name, T_Peptide_Cleavage_State_Name, T_Peptide_State_Name, T_Peptide_Terminus_State_Name, T_Process_Config, T_Process_Config_Parameters, T_Process_Step_Control, T_Quantitation_Defaults, T_Quantitation_State_Name, V_Config_Info, V_DB_Schema_Version, V_External_Databases, V_Filter_Set_Overview, V_Filter_Set_Overview_Ex, V_Filter_Set_Report, V_General_Statistics_Report, V_Table_Row_Counts' ,
...
GO
GRANT VIEW DEFINITION ON [dbo].[SetPermissionRestrictions] TO [MTS_DB_Dev] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[SetPermissionRestrictions] TO [MTS_DB_Lite] AS [dbo]
GO
