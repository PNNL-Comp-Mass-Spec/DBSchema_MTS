...
AS 
	...
	Begin Try
		...
		BEGIN
			...
			Set @CurrentLocation = 'Process QID ' + Convert(varchar(19), @QuantitationID)
		...
		Set @CurrentLocation = 'Return the summary stats'
...
End Try
	Begin Catch
		...
		Set @CallingProcName = IsNull(ERROR_PROCEDURE(), 'QRSummary')
...
GO
GRANT EXECUTE ON [dbo].[QRSummary] TO [DMS_SP_User] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[QRSummary] TO [MTS_DB_Dev] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[QRSummary] TO [MTS_DB_Lite] AS [dbo]
GO
