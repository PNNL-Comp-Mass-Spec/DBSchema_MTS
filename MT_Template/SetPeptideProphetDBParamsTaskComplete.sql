...
GO
GRANT VIEW DEFINITION ON [dbo].[SetPeptideProphetDBParamsTaskComplete] TO [MTS_DB_Dev] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[SetPeptideProphetDBParamsTaskComplete] TO [MTS_DB_Lite] AS [dbo]
GO
GRANT EXECUTE ON [dbo].[SetPeptideProphetDBParamsTaskComplete] TO [pnl\MTSProc] AS [dbo]
GO
GRANT EXECUTE ON [dbo].[SetPeptideProphetDBParamsTaskComplete] TO [pnl\svc-dms] AS [dbo]
GO
