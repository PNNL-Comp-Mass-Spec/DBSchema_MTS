...
CREATE TABLE [dbo].[T_Quantitation_Defaults](
	...
	[Minimum_High_Discriminant_Score] [real] NOT NULL CONSTRAINT [DF_T_Quantitation_Defaults_Minimum_High_Discriminant_Score]  DEFAULT ((0)),
	...
	[Maximum_Matches_per_UMC_to_Keep] [smallint] NOT NULL CONSTRAINT [DF_T_Quantitation_Defaults_Maximum_Matches_per_UMC_to_Keep]  DEFAULT ((1)),
	[Minimum_Match_Score] [real] NOT NULL CONSTRAINT [DF_T_Quantitation_Defaults_Minimum_Match_Score]  DEFAULT ((0.25)),
	[Minimum_Del_Match_Score] [real] NOT NULL CONSTRAINT [DF_T_Quantitation_Defaults_Minimum_Del_Match_Score]  DEFAULT ((0)),
