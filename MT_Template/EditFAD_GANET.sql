...
GO
GRANT EXECUTE ON [dbo].[EditFAD_GANET] TO [DMS_SP_User] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[EditFAD_GANET] TO [MTS_DB_Dev] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[EditFAD_GANET] TO [MTS_DB_Lite] AS [dbo]
GO
