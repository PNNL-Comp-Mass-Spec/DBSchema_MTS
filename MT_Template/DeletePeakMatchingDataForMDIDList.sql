...
GO
GRANT VIEW DEFINITION ON [dbo].[DeletePeakMatchingDataForMDIDList] TO [MTS_DB_Dev] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[DeletePeakMatchingDataForMDIDList] TO [MTS_DB_Lite] AS [dbo]
GO
