...
CREATE TABLE [dbo].[T_Mass_Tags](
	...
	[Created] [datetime] NULL CONSTRAINT [DF_T_Mass_Tags_Created]  DEFAULT (getdate()),
	[Last_Affected] [datetime] NULL CONSTRAINT [DF_T_Mass_Tags_Last_Affected]  DEFAULT (getdate()),
