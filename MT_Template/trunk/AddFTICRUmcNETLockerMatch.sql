...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[AddFTICRUmcNETLockerMatch]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[AddFTICRUmcNETLockerMatch]
GO
...
**
**	Date: 12/31/2003 Author: mem
**  Modelled after AddFTICRUmcMatch
**  
**  Updated: 01/02/2004 mem
...
(
	...
	@GANETLockerID int,					-- reference to T_GANET_Lockers
...
As
	...
	--append new row to the T_FTICR_UMC_NETLockerDetails table
	INSERT INTO dbo.T_FTICR_UMC_NETLockerDetails
		(UMC_Results_ID, Seq_ID, Match_Score, Match_State, Predicted_NET, Matching_Member_Count, Del_Match_Score)
	VALUES (@UMCResultsID, @GANETLockerID, @MatchScore, @MatchState, @PredictedGANET, @MatchingMemberCount, @DelMatchScore)
	--
