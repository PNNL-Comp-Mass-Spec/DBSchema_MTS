/****** Object:  StoredProcedure [dbo].[GetPeakMatchingTaskResultStats] ******/
SET ANSI_NULLS ON
GO
...
GO
GRANT EXECUTE ON [dbo].[GetPeakMatchingTaskResultStats] TO [DMS_SP_User] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[GetPeakMatchingTaskResultStats] TO [MTS_DB_Dev] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[GetPeakMatchingTaskResultStats] TO [MTS_DB_Lite] AS [dbo]
GO
