if exists (select * from dbo.sysobjects where id = object_id(N'[T_Quantitation_Defaults]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [T_Quantitation_Defaults]
GO

CREATE TABLE [T_Quantitation_Defaults] (
