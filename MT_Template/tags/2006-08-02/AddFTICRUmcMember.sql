...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[AddFTICRUmcMember]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[AddFTICRUmcMember]
GO
...
GRANT  EXECUTE  ON [dbo].[AddFTICRUmcMember]  TO [DMS_SP_User]
GO
