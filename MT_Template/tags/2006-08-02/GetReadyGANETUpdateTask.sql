...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[GetReadyGANETUpdateTask]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[GetReadyGANETUpdateTask]
GO
