/****** Object:  StoredProcedure [dbo].[RefreshCachedGeneralStatistics] ******/
SET ANSI_NULLS ON
GO
...
GO
GRANT VIEW DEFINITION ON [dbo].[RefreshCachedGeneralStatistics] TO [MTS_DB_Dev] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[RefreshCachedGeneralStatistics] TO [MTS_DB_Lite] AS [dbo]
GO
