...
CREATE DATABASE [MTS_Master]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'MTS_Master', FILENAME = N'J:\SQLServerData\MTS_Master_data.mdf' , SIZE = 125888KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'MTS_Master_log', FILENAME = N'L:\SQLServerData\MTS_Master_log.ldf' , SIZE = 1782272KB , MAXSIZE = UNLIMITED, FILEGROWTH = 16384KB )
