...
( NAME = N'MTS_Master', FILENAME = N'I:\SQLServerData\MTS_Master.mdf' , SIZE = 38080KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
 LOG ON 
( NAME = N'MTS_Master_log', FILENAME = N'H:\SQLServerData\MTS_Master_log.ldf' , SIZE = 88384KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
