...
CREATE TABLE [dbo].[T_MTS_DB_Errors](
	...
	[DB_Error_State] [tinyint] NOT NULL CONSTRAINT [DF_T_MTS_DB_Errors_DB_Error_State]  DEFAULT ((1)),
	[Last_Affected] [datetime] NOT NULL CONSTRAINT [DF_T_MTS_DB_Errors_Last_Affected]  DEFAULT (getdate()),
