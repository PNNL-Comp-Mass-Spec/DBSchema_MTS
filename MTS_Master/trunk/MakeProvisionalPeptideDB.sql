...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[MakeProvisionalPeptideDB]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[MakeProvisionalPeptideDB]
GO
...
GRANT  EXECUTE  ON [dbo].[MakeProvisionalPeptideDB]  TO [MTUser]
GO
