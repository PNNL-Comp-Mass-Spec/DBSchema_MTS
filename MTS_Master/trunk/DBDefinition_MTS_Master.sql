...
( NAME = N'MTS_Master', FILENAME = N'I:\SQLServerData\MTS_Master.mdf' , SIZE = 35904KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
 LOG ON 
( NAME = N'MTS_Master_log', FILENAME = N'H:\SQLServerData\MTS_Master_log.ldf' , SIZE = 82368KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
