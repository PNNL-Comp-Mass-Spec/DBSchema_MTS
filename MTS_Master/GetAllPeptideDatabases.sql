/****** Object:  StoredProcedure [dbo].[GetAllPeptideDatabases] ******/
SET ANSI_NULLS ON
GO
		...
		Begin -- <a>
			...
			Begin -- <b>
				...
				Begin Catch
					...
					Set @CallingProcName = IsNull(ERROR_PROCEDURE(), 'GetAllPeptideDatabases')
...
GO
GRANT EXECUTE ON [dbo].[GetAllPeptideDatabases] TO [DMS_SP_User] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[GetAllPeptideDatabases] TO [MTS_DB_Dev] AS [dbo]
GO
