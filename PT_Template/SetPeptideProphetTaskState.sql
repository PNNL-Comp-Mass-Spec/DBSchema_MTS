/****** Object:  StoredProcedure [dbo].[SetPeptideProphetTaskState] ******/
SET ANSI_NULLS ON
GO
...
GO
GRANT VIEW DEFINITION ON [dbo].[SetPeptideProphetTaskState] TO [MTS_DB_Dev] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[SetPeptideProphetTaskState] TO [MTS_DB_Lite] AS [dbo]
GO
