/****** Object:  StoredProcedure [dbo].[SetPermissions] ******/
SET ANSI_NULLS ON
GO
...
GO
GRANT VIEW DEFINITION ON [dbo].[SetPermissions] TO [MTS_DB_Dev] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[SetPermissions] TO [MTS_DB_Lite] AS [dbo]
GO
