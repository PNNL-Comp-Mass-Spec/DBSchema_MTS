/****** Object:  StoredProcedure [dbo].[ProcessPeptideProphetResultsOneTask] ******/
SET ANSI_NULLS ON
GO
...
GO
GRANT VIEW DEFINITION ON [dbo].[ProcessPeptideProphetResultsOneTask] TO [MTS_DB_Dev] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[ProcessPeptideProphetResultsOneTask] TO [MTS_DB_Lite] AS [dbo]
GO
