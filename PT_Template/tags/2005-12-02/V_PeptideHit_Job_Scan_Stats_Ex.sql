...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[V_PeptideHit_Job_Scan_Stats_Ex]') and OBJECTPROPERTY(id, N'IsView') = 1)
drop view [dbo].[V_PeptideHit_Job_Scan_Stats_Ex]
GO
