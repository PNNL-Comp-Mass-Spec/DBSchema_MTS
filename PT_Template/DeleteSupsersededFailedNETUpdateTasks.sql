...
GO
GRANT VIEW DEFINITION ON [dbo].[DeleteSupsersededFailedNETUpdateTasks] TO [MTS_DB_Dev]
GO
GRANT VIEW DEFINITION ON [dbo].[DeleteSupsersededFailedNETUpdateTasks] TO [MTS_DB_Lite]
GO
