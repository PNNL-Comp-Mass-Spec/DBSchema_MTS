/****** Object:  StoredProcedure [dbo].[DropTempSequenceTables] ******/
SET ANSI_NULLS ON
GO
...
GO
GRANT EXECUTE ON [dbo].[DropTempSequenceTables] TO [DMS_SP_User] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[DropTempSequenceTables] TO [MTS_DB_Dev] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[DropTempSequenceTables] TO [MTS_DB_Lite] AS [dbo]
GO
