/****** Object:  StoredProcedure [dbo].[CreateTempSequenceTables] ******/
SET ANSI_NULLS ON
GO
...
GO
GRANT EXECUTE ON [dbo].[CreateTempSequenceTables] TO [DMS_SP_User] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[CreateTempSequenceTables] TO [MTS_DB_Dev] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[CreateTempSequenceTables] TO [MTS_DB_Lite] AS [dbo]
GO
