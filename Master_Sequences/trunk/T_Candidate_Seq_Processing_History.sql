...
CREATE TABLE [dbo].[T_Candidate_Seq_Processing_History](
	...
	[Queue_State] [smallint] NOT NULL CONSTRAINT [DF_T_Candidate_Seq_Processing_History_Queue_State]  DEFAULT ((1)),
	[Last_Affected] [datetime] NOT NULL CONSTRAINT [DF_T_Candidate_Seq_Processing_History_Last_Affected]  DEFAULT (getdate()),
	[Entered_Queue] [datetime] NOT NULL CONSTRAINT [DF_T_Candidate_Seq_Processing_History_Time_Queued]  DEFAULT (getdate()),
	[Sequence_Count] [int] NULL,
	[Sequence_Count_New] [int] NULL,
	[Processing_Start] [datetime] NULL,
	[Processing_Complete] [datetime] NULL,
	[Status_Message] [varchar](512) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_T_Candidate_Seq_Processing_History_Status_Message]  DEFAULT (''),
...
GO
GRANT INSERT ON [dbo].[T_Candidate_Seq_Processing_History] TO [DMS_SP_User]
GO
GRANT UPDATE ON [dbo].[T_Candidate_Seq_Processing_History] TO [DMS_SP_User]
GO
