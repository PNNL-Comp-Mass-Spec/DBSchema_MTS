		...
		begin
			...
			Begin
				...
				Begin
					...
					Values 
						(@seqID, @massCorrectionTag, @modPos)
					--
...
GO
GRANT VIEW DEFINITION ON [dbo].[UnrollModDescription] TO [MTS_DB_Dev] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[UnrollModDescription] TO [MTS_DB_Lite] AS [dbo]
GO
