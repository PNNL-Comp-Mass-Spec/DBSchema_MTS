...
CREATE TABLE [dbo].[T_Analysis_Job](
	...
	[Priority] [smallint] NULL CONSTRAINT [DF_T_Analysis_Job_Priority]  DEFAULT ((3)),
	[Job_Start] [datetime] NULL,
	[Job_Finish] [datetime] NULL,
	[Tool_ID] [int] NOT NULL CONSTRAINT [DF_T_Analysis_Job_Tool_ID]  DEFAULT ((0)),
	[Comment] [varchar](255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[State_ID] [int] NOT NULL CONSTRAINT [DF_T_Analysis_Job_State_ID]  DEFAULT ((1)),
	...
	[Analysis_Manager_Error] [int] NOT NULL CONSTRAINT [DF_T_Analysis_Job_Analysis_Manager_Error]  DEFAULT ((0)),
	[Analysis_Manager_Warning] [int] NOT NULL CONSTRAINT [DF_T_Analysis_Job_Analysis_Manager_Warning]  DEFAULT ((0)),
