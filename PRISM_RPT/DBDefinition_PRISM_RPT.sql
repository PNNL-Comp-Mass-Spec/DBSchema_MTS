...
CREATE DATABASE [PRISM_RPT]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'PRISM_RPT_Data', FILENAME = N'J:\SQLServerData\PRISM_RPT_data.mdf' , SIZE = 292032KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
 LOG ON 
( NAME = N'PRISM_RPT_Log', FILENAME = N'L:\SQLServerData\PRISM_RPT_log.ldf' , SIZE = 300416KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
...
GO
ALTER DATABASE [PRISM_RPT] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [PRISM_RPT] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
ALTER DATABASE [PRISM_RPT] SET DELAYED_DURABILITY = DISABLED 
GO
USE [PRISM_RPT]
GO
/****** Object:  User [d3m578] ******/
