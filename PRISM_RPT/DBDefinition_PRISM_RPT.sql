...
CREATE DATABASE [PRISM_RPT]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'PRISM_RPT_Data', FILENAME = N'J:\SQLServerData\PRISM_RPT_data.mdf' , SIZE = 282752KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
 LOG ON 
( NAME = N'PRISM_RPT_Log', FILENAME = N'L:\SQLServerData\PRISM_RPT_log.ldf' , SIZE = 441536KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
