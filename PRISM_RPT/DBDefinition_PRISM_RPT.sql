...
( NAME = N'PRISM_RPT_Data', FILENAME = N'I:\SQLServerData\PRISM_RPT_data.mdf' , SIZE = 69504KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
 LOG ON 
( NAME = N'PRISM_RPT_Log', FILENAME = N'H:\SQLServerData\PRISM_RPT_log.ldf' , SIZE = 127104KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
