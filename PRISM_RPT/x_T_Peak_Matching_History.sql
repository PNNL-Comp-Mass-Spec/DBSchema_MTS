/****** Object:  Table [dbo].[x_T_Peak_Matching_History] ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[x_T_Peak_Matching_History](
...
CREATE NONCLUSTERED INDEX [IX_T_Peak_Matching_History_MTDBName] ON [dbo].[x_T_Peak_Matching_History] 
(
	[MTDBName] ASC
...
CREATE NONCLUSTERED INDEX [IX_T_Peak_Matching_History_ProcessorName] ON [dbo].[x_T_Peak_Matching_History] 
(
