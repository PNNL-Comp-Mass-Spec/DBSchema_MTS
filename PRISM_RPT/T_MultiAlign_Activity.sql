...
GO
ALTER TABLE [dbo].[T_MultiAlign_Activity] ADD  CONSTRAINT [DF_T_MultiAlign_Activity_Tool_Version]  DEFAULT ('Unknown') FOR [Tool_Version]
GO
ALTER TABLE [dbo].[T_MultiAlign_Activity] ADD  CONSTRAINT [DF_T_MultiAlign_Activity_Working]  DEFAULT ((0)) FOR [Working]
GO
ALTER TABLE [dbo].[T_MultiAlign_Activity] ADD  CONSTRAINT [DF_T_MultiAlign_Activity_Tasks_Completed]  DEFAULT ((0)) FOR [Tasks_Completed]
GO
