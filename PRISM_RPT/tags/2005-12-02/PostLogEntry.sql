...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[PostLogEntry]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[PostLogEntry]
GO
...
GRANT  EXECUTE  ON [dbo].[PostLogEntry]  TO [msdadmin]
GO
