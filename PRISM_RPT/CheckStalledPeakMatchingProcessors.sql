/****** Object:  StoredProcedure [dbo].[CheckStalledPeakMatchingProcessors] ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE dbo.CheckStalledPeakMatchingProcessors
/****************************************************
**
**	Desc: 
**		Uses V_PeakMatching_Tasks_Stalled to see whether 
	...
	Begin
		...
		Begin
			...
			Begin
				...
				FROM T_Log_Entries
				WHERE posted_by = 'CheckStalledPeakMatchingProcessors' AND 
			...
			Begin
				Exec PostLogEntry 'Error', @Message, 'CheckStalledPeakMatchingProcessors'
			End
		End
	End	
...
GO
GRANT VIEW DEFINITION ON [dbo].[CheckStalledPeakMatchingProcessors] TO [MTS_DB_Dev] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[CheckStalledPeakMatchingProcessors] TO [MTS_DB_Lite] AS [dbo]
GO
