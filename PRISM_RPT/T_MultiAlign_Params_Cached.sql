/****** Object:  Table [dbo].[T_MultiAlign_Params_Cached] ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[T_MultiAlign_Params_Cached](
	[Job_ID] [int] NOT NULL,
	...
	[DMS_Job_List] [varchar](max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
 ...
 CONSTRAINT [PK_T_MultiAlign_Params_Cached] PRIMARY KEY CLUSTERED 
(
	[Job_ID] ASC
...
GO
ALTER TABLE [dbo].[T_MultiAlign_Params_Cached] ADD  CONSTRAINT [DF_T_MultiAlign_Params_Cached_Cache_Date]  DEFAULT (getdate()) FOR [Cache_Date]
GO
