...
GO
ALTER TABLE [dbo].[T_Analysis_Job_to_MT_DB_Map]  WITH CHECK ADD  CONSTRAINT [FK_T_Analysis_Job_to_MT_DB_Map_T_MT_Database_List] FOREIGN KEY([MTL_ID])
REFERENCES [dbo].[T_MT_Database_List] ([MTL_ID])
GO
