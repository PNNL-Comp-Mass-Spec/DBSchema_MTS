...
**
**  Desc:
**      Updates the data in T_DMS_Analysis_Job_Info_Cached using DMS
**
...
**          05/09/2024 mem - Store an empty string when StoragePathClient is null
**
*****************************************************/
(
...
AS
    ...
    Begin Try
        ...
        Set @S = @S +               ' Coalesce(StoragePathClient, '''') AS StoragePathClient, StoragePathServer, DatasetFolder,'
        ...
        Begin
            ...
            Exec PostLogEntry 'Error', @message, 'RefreshCachedDMSAnalysisJobInfo'
        End
        Else
        Begin
