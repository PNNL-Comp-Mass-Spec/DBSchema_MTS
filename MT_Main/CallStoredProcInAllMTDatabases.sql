/****** Object:  StoredProcedure [dbo].[CallStoredProcInAllMTDatabases] ******/
SET ANSI_NULLS ON
GO
...
GO
GRANT EXECUTE ON [dbo].[CallStoredProcInAllMTDatabases] TO [DMS_SP_User] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[CallStoredProcInAllMTDatabases] TO [MTS_DB_Dev] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[CallStoredProcInAllMTDatabases] TO [MTS_DB_Lite] AS [dbo]
GO
