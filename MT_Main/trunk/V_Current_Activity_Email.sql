...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[V_Current_Activity_Email]') and OBJECTPROPERTY(id, N'IsView') = 1)
drop view [dbo].[V_Current_Activity_Email]
GO
