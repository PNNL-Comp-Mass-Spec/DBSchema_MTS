...
( NAME = N'MT_Main_Data', FILENAME = N'F:\SQLServerData\MT_Main_data.mdf' , SIZE = 629760KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
 LOG ON 
( NAME = N'MT_Main_Log', FILENAME = N'D:\SQLServerData\MT_Main_log.ldf' , SIZE = 11200KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
