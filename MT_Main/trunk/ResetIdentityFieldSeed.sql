...
**			03/14/2006 mem - Customized for MT_Main
**			07/23/2006 mem - Removed reference to table T_PMT_Quality_Score_Sets
**
*****************************************************/
(
	@InfoOnly tinyint = 0,
...
AS
	...
	*/
	...
	INSERT INTO #Tmp_TablesToUpdate (Table_Name, Field_Name) VALUES ('T_Current_Activity_History', 'History_ID')
	INSERT INTO #Tmp_TablesToUpdate (Table_Name, Field_Name) VALUES ('T_Internal_Standards', 'Internal_Std_Mix_ID')
	INSERT INTO #Tmp_TablesToUpdate (Table_Name, Field_Name) VALUES ('T_Internal_Std_Proteins', 'Internal_Std_Protein_ID')
