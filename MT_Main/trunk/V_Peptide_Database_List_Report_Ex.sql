...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[V_Peptide_Database_List_Report_Ex]') and OBJECTPROPERTY(id, N'IsView') = 1)
drop view [dbo].[V_Peptide_Database_List_Report_Ex]
GO
