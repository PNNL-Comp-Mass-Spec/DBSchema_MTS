...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[GetDatabaseConnectionStringEx]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[GetDatabaseConnectionStringEx]
GO
...
GRANT  EXECUTE  ON [dbo].[GetDatabaseConnectionStringEx]  TO [DMS_SP_User]
GO
