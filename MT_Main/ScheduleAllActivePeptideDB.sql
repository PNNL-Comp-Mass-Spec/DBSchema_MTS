/****** Object:  StoredProcedure [dbo].[ScheduleAllActivePeptideDB] ******/
SET ANSI_NULLS ON
GO
...
GO
GRANT EXECUTE ON [dbo].[ScheduleAllActivePeptideDB] TO [DMS_SP_User] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[ScheduleAllActivePeptideDB] TO [MTS_DB_Dev] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[ScheduleAllActivePeptideDB] TO [MTS_DB_Lite] AS [dbo]
GO
