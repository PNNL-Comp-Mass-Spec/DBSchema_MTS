/****** Object:  StoredProcedure [dbo].[GetMTAssignedDBs] ******/
SET ANSI_NULLS ON
GO
...
GO
GRANT EXECUTE ON [dbo].[GetMTAssignedDBs] TO [DMS_SP_User] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[GetMTAssignedDBs] TO [MTS_DB_Dev] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[GetMTAssignedDBs] TO [MTS_DB_Lite] AS [dbo]
GO
