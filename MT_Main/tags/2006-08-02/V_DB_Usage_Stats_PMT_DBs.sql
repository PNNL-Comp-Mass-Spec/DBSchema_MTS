...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[V_DB_Usage_Stats_PMT_DBs]') and OBJECTPROPERTY(id, N'IsView') = 1)
drop view [dbo].[V_DB_Usage_Stats_PMT_DBs]
GO
