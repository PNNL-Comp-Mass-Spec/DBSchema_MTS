...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[GetGANETTaskActivity]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[GetGANETTaskActivity]
GO
...
GRANT  EXECUTE  ON [dbo].[GetGANETTaskActivity]  TO [DMS_SP_User]
GO
