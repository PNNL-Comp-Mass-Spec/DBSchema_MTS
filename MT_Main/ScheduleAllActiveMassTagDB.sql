...
GO
GRANT EXECUTE ON [dbo].[ScheduleAllActiveMassTagDB] TO [DMS_SP_User] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[ScheduleAllActiveMassTagDB] TO [MTS_DB_Dev] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[ScheduleAllActiveMassTagDB] TO [MTS_DB_Lite] AS [dbo]
GO
