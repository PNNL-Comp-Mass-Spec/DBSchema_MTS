...
CREATE DATABASE [MT_Main]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'MT_Main_Data', FILENAME = N'J:\SQLServerData\MT_Main_data.mdf' , SIZE = 1934208KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
 LOG ON 
( NAME = N'MT_Main_Log', FILENAME = N'L:\SQLServerData\MT_Main_log.ldf' , SIZE = 625792KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
