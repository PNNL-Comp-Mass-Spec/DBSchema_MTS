...
CREATE DATABASE [MT_Main]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'MT_Main_Data', FILENAME = N'J:\SQLServerData\MT_Main_data.mdf' , SIZE = 1758336KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
 LOG ON 
( NAME = N'MT_Main_Log', FILENAME = N'L:\SQLServerData\MT_Main_log.ldf' , SIZE = 770112KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
...
GO
ALTER DATABASE [MT_Main] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [MT_Main] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
ALTER DATABASE [MT_Main] SET DELAYED_DURABILITY = DISABLED 
GO
USE [MT_Main]
GO
/****** Object:  User [d3m578] ******/
