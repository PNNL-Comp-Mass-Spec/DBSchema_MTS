...
GO
GRANT EXECUTE ON [dbo].[ScheduleOneMassTagDB] TO [DMS_SP_User] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[ScheduleOneMassTagDB] TO [MTS_DB_Dev] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[ScheduleOneMassTagDB] TO [MTS_DB_Lite] AS [dbo]
GO
