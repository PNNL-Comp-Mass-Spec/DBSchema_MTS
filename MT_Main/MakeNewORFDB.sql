...
GO
GRANT EXECUTE ON [dbo].[MakeNewORFDB] TO [DMS_SP_User] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[MakeNewORFDB] TO [MTS_DB_Dev] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[MakeNewORFDB] TO [MTS_DB_Lite] AS [dbo]
GO
