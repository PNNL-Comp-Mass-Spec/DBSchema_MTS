...
( NAME = N'dba', FILENAME = N'I:\SQLServerData\dba.mdf' , SIZE = 2054592KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'dba_log', FILENAME = N'H:\SQLServerData\dba_log.LDF' , SIZE = 35712KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
