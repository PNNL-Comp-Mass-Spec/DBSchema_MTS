...
CREATE DATABASE [dba]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'dba', FILENAME = N'J:\SQLServerData\dba.mdf' , SIZE = 1607680KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'dba_log', FILENAME = N'L:\SQLServerData\dba_log.LDF' , SIZE = 241216KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
