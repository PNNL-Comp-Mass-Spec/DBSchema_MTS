...
( NAME = N'dba', FILENAME = N'I:\SQLServerData\dba.mdf' , SIZE = 10688KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'dba_log', FILENAME = N'H:\SQLServerData\dba_log.LDF' , SIZE = 1792KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
