...
CREATE TABLE [dbo].[FileStatsHistory](
	...
	[FileMBSize] [nvarchar](30) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	...
	[FileMBUsed] [nvarchar](30) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[FileMBEmpty] [nvarchar](30) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[FilePercentEmpty] [numeric](12, 2) NULL,
	[LargeLDF] [int] NULL,
	[FileGroup] [nvarchar](100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[NumberReads] [nvarchar](30) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[KBytesRead] [numeric](20, 2) NULL,
	[NumberWrites] [nvarchar](30) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
