...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[GetExportFilterIDsForPeptideDB]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[GetExportFilterIDsForPeptideDB]
GO
...
GRANT  EXECUTE  ON [dbo].[GetExportFilterIDsForPeptideDB]  TO [DMS_SP_User]
GO
