...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[GetQRollupsGlossary]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[GetQRollupsGlossary]
GO
...
GRANT  EXECUTE  ON [dbo].[GetQRollupsGlossary]  TO [DMS_SP_User]
GO
