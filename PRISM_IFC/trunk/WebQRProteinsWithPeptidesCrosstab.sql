...
AS
	...
	set @stmt = N'exec [' + @MTDBName + N'].dbo.QRProteinsWithPeptidesCrosstab @QuantitationIDList, @SeparateReplicateDataIDs, @SourceColName, @AggregateColName, @AverageAcrossColumns, @IncludePrefixAndSuffixResidues, @SortMode'
