...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[GetProteinJobPeptideCrosstab_20051026]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[GetProteinJobPeptideCrosstab_20051026]
GO

CREATE PROCEDURE dbo.GetProteinJobPeptideCrosstab_20051026
/****************************************************
**	Desc:  
