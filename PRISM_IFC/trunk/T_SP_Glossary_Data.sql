...
INSERT INTO [T_SP_Glossary] VALUES (11,'minimumPMTQualityScore',1,11,'float',8,'Minimum Quality Score required of PMTs used in peak matching (Scale 0-2, 2 is best quality).')
...
INSERT INTO [T_SP_Glossary] VALUES (11,'PMT_Quality_Score',3,12,'numeric',5,'Minimum Quality Score required for PMT match (Scale 0-2, 2 is best quality)')
...
INSERT INTO [T_SP_Glossary] VALUES (18,'minimumPMTQualityScore',1,11,'float',8,'Minimum Quality Score required of PMTs used in peak matching (Scale 0-2, 2 is best quality).')
...
INSERT INTO [T_SP_Glossary] VALUES (21,'Min PMT Quality Score',3,15,'real',4,'Minimum Quality Score required of PMTs used in peak matching (Scale 0-2, 2 is best quality).')
INSERT INTO [T_SP_Glossary] VALUES (21,'Min SLiC Score',3,16,'real',4,'Minimum SLIC score required of PMTs used in peak matching (scale 0 to 1).')
INSERT INTO [T_SP_Glossary] VALUES (21,'Min Del SLiC Score',3,17,'real',4,'Minimum Del SLIC score required of PMTs used in peak matching (scale 0 to 1).')
INSERT INTO [T_SP_Glossary] VALUES (21,'Min Peptide Length',3,18,'tinyint',1,'Minimum number of amino acids per peptide required of PMTs used in peak matching.')
INSERT INTO [T_SP_Glossary] VALUES (21,'Min Peptide Rep Count',3,19,'smallint',2,'Minimum number of repeat observations (replicates) required for each PMT (peptide) to be included in the report.  Ignored for Q Rollups that are not replicate-based.')
INSERT INTO [T_SP_Glossary] VALUES (21,'ORF Coverage Computation Level',3,20,'tinyint',1,'Amount of detail to include for protein (ORF) coverage.  If 0, then no protein coverage is computed.  If 1, then observed protein coverage is computed.  If 2, then both potential and observed protein coverage is computed (possibly very time consuming).')
INSERT INTO [T_SP_Glossary] VALUES (21,'Rep Norm Stats',3,21,'varchar',1024,'Summary of the normalization steps applied for replicate-based Q Rollups.')
INSERT INTO [T_SP_Glossary] VALUES (21,'Quantitation State ID',3,22,'tinyint',1,'Processing state for the Q Rollup; 1=New, 2=Processing, 3=Success, 4=Failure, 5=Superseded.')
INSERT INTO [T_SP_Glossary] VALUES (21,'State',3,23,'varchar',50,'Processing state for the Q Rollup.')
INSERT INTO [T_SP_Glossary] VALUES (21,'Last Affected',3,24,'datetime',8,'Date that the Q Rollup was last updated.')
...
INSERT INTO [T_SP_Glossary] VALUES (24,'minimumPMTQualityScore',1,10,'varchar',32,'Minimum Quality Score required of PMTs used in peak matching (Scale 0-2, 2 is best quality).')
...
INSERT INTO [T_SP_Glossary] VALUES (24,'PMT_Quality_Score',3,12,'numeric',5,'Minimum Quality Score required for PMT match (Scale 0-2, 2 is best quality)')
...
INSERT INTO [T_SP_Glossary] VALUES (26,'minimumPMTQualityScore',1,10,'varchar',32,'Minimum Quality Score required of PMTs used in peak matching (Scale 0-2, 2 is best quality).')
...
INSERT INTO [T_SP_Glossary] VALUES (27,'Min PMT Quality Score',3,15,'real',4,'Minimum Quality Score required of PMTs used in peak matching (Scale 0-2, 2 is best quality).')
INSERT INTO [T_SP_Glossary] VALUES (27,'Min SLiC Score',3,16,'real',4,'Minimum SLIC score required of PMTs used in peak matching (scale 0 to 1).')
INSERT INTO [T_SP_Glossary] VALUES (27,'Min Del SLiC Score',3,17,'real',4,'Minimum Del SLIC score required of PMTs used in peak matching (scale 0 to 1).')
INSERT INTO [T_SP_Glossary] VALUES (27,'Min Peptide Length',3,18,'tinyint',1,'Minimum number of amino acids per peptide required of PMTs used in peak matching.')
INSERT INTO [T_SP_Glossary] VALUES (27,'Min Peptide Rep Count',3,19,'smallint',2,'Minimum number of repeat observations (replicates) required for each PMT (peptide) to be included in the report.  Ignored for Q Rollups that are not replicate-based.')
INSERT INTO [T_SP_Glossary] VALUES (27,'ORF Coverage Computation Level',3,20,'tinyint',1,'Amount of detail to include for protein (ORF) coverage.  If 0, then no protein coverage is computed.  If 1, then observed protein coverage is computed.  If 2, then both potential and observed protein coverage is computed (possibly very time consuming).')
INSERT INTO [T_SP_Glossary] VALUES (27,'Rep Norm Stats',3,21,'varchar',50,'Summary of the normalization steps applied for replicate-based Q Rollups.')
INSERT INTO [T_SP_Glossary] VALUES (27,'Quantitation State ID',3,22,'tinyint',1,'Processing state for the Q Rollup; 1=New, 2=Processing, 3=Success, 4=Failure, 5=Superseded.')
INSERT INTO [T_SP_Glossary] VALUES (27,'State',3,23,'varchar',50,'Processing state for the Q Rollup.')
INSERT INTO [T_SP_Glossary] VALUES (27,'Last Affected',3,24,'datetime',8,'Date that the Q Rollup was last updated.')
...
INSERT INTO [T_SP_Glossary] VALUES (28,'Minimum_PMT_Quality_Score',3,12,'decimal',5,'Minimum Quality Score required of PMTs used in peak matching (Scale 0-2, 2 is best quality).')
...
INSERT INTO [T_SP_Glossary] VALUES (34,'PMT_Quality_Score',3,33,'decimal',5,'Rough indication of the confidence of the PMT identity based on LC-MS/MS data.  This value is typically 0, 1, or 2, with 0 being low confidence, 1 being higher, and 2 being the highest.  The confidence is based on XCorr and DelCn cutoff values that vary from database to database.')
INSERT INTO [T_SP_Glossary] VALUES (34,'Protein_Count',3,34,'tinyint',1,'Number of proteins that the given PMT (peptide) is present in (aka protein or ORF degeneracy).  If the peptide sequence is only present in one protein''s sequence, then Protein_Count = 1.  If the peptide sequence is present in two proteins'' sequences, then Protein_Count = 2.')
INSERT INTO [T_SP_Glossary] VALUES (34,'Cleavage_State_Name',3,35,'varchar',50,'The enzymatic cleavage state for the given PMT (peptide), in the context of the given protein.')
INSERT INTO [T_SP_Glossary] VALUES (34,'UMC_MatchCount_Avg',3,36,'decimal',5,'Number of UMCs that matched the given PMT.  If replicate or fractionated datasets are rolled up in this Q Rollup, then this is the average of the UMC match count for each.')
INSERT INTO [T_SP_Glossary] VALUES (34,'Scan_Minimum',3,37,'int',4,'Ending scan number of the UMCs that matched the given PMT (peptide).')
INSERT INTO [T_SP_Glossary] VALUES (34,'Scan_Maximum',3,38,'int',4,'Ending scan number of the UMCs that matched the given PMT (peptide).')
INSERT INTO [T_SP_Glossary] VALUES (34,'NET_Minimum',3,39,'decimal',5,'Minimum NET for the UMC matching this PMT.  If only one dataset is included in the rollup, then NET_Minimum will be the same as NET_Maximum.  If more than one dataset is rolled up, then this is the minimum NET of all UMCs that matched the given PMT.')
INSERT INTO [T_SP_Glossary] VALUES (34,'NET_Maximum',3,40,'decimal',5,'Maximum NET for the UMC matching this PMT.  If only one dataset is included in the rollup, then NET_Maximum will be the same as NET_Minimum.  If more than one dataset is rolled up, then this is the maximum NET of all UMCs that matched the given PMT.')
INSERT INTO [T_SP_Glossary] VALUES (34,'Charge_Basis_Avg',3,41,'decimal',5,'The primary charge state associated with the UMC that matched the given PMT.  If several UMCs led to this identification, then this is the average of the primary charge states for each.  If replicate or fractionated datasets are rolled up in this Q Rollup, then this is the average of the primary charge states for each.')
INSERT INTO [T_SP_Glossary] VALUES (34,'Charge_State_Min',3,42,'tinyint',1,'The minimum charge state associated with the UMC(s) that matched the given PMT.')
INSERT INTO [T_SP_Glossary] VALUES (34,'Charge_State_Max',3,43,'tinyint',1,'The maximum charge state associated with the UMC(s) that matched the given PMT.')
INSERT INTO [T_SP_Glossary] VALUES (34,'MT_Mass_Error_PPM_Avg',3,44,'decimal',5,'Mass difference, in ppm, between the UMC''s median mass and the PMT''s theoretical monoisotopic mass.  This value will be the average of several values if replicate results are rolled up.')
INSERT INTO [T_SP_Glossary] VALUES (34,'NET_Error_Obs_Avg',3,45,'decimal',5,'NET difference between the UMC''s median NET and the PMT''s observed NET.  This value will be the average of several values if replicate results are rolled up.')
INSERT INTO [T_SP_Glossary] VALUES (34,'NET_Error_Pred_Avg',3,46,'decimal',5,'NET difference between the UMC''s median NET and the PMT''s predicted NET.  The predicted NET is different than the observed NET for a PMT since the observed NET is the average observed elution time for the peptide while the predicted NET is the elution time predicted by a trained prediction model.  This value will be the average of several values if replicate results are rolled up.')
INSERT INTO [T_SP_Glossary] VALUES (34,'Used_For_Abundance_Computation',3,47,'tinyint',1,'Will be 1 if the given PMT (peptide) was included in the group of PMTs whose abundance values were averaged together to compute the protein abundance value for the protein associated with this PMT.')
