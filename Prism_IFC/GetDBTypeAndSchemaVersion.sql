/****** Object:  StoredProcedure [dbo].[GetDBTypeAndSchemaVersion] ******/
SET ANSI_NULLS ON
GO
...
GO
GRANT EXECUTE ON [dbo].[GetDBTypeAndSchemaVersion] TO [DMS_SP_User] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[GetDBTypeAndSchemaVersion] TO [MTS_DB_Dev] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[GetDBTypeAndSchemaVersion] TO [MTS_DB_Lite] AS [dbo]
GO
