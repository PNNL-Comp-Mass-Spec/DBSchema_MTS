...
GO
CREATE PROCEDURE GetQRollupsSummary
/****************************************************
**
**	Desc: 
...
GO
GRANT EXECUTE ON [dbo].[GetQRollupsSummary] TO [DMS_SP_User] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[GetQRollupsSummary] TO [MTS_DB_Dev] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[GetQRollupsSummary] TO [MTS_DB_Lite] AS [dbo]
GO
