/****** Object:  StoredProcedure [dbo].[GetAllProteins] ******/
SET ANSI_NULLS ON
GO
...
GO
GRANT EXECUTE ON [dbo].[GetAllProteins] TO [DMS_SP_User] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[GetAllProteins] TO [MTS_DB_Dev] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[GetAllProteins] TO [MTS_DB_Lite] AS [dbo]
GO
