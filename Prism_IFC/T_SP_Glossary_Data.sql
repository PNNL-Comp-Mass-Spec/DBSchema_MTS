...
INSERT INTO [T_SP_Glossary] VALUES (1,'VerboseColumnOutput',1,5,'tinyint',1,null)
...
INSERT INTO [T_SP_Glossary] VALUES (2,'IncludeUnused',1,4,'varchar',32,null)
INSERT INTO [T_SP_Glossary] VALUES (2,'ServerFilter',1,6,'varchar',128,null)
...
INSERT INTO [T_SP_Glossary] VALUES (3,'ServerFilter',1,4,'varchar',128,null)
INSERT INTO [T_SP_Glossary] VALUES (3,'VerboseColumnOutput',1,5,'tinyint',1,null)
...
INSERT INTO [T_SP_Glossary] VALUES (4,'ServerFilter',1,6,'varchar',128,null)
...
INSERT INTO [T_SP_Glossary] VALUES (34,'VerboseColumnOutput',1,7,'tinyint',1,null)
...
INSERT INTO [T_SP_Glossary] VALUES (34,'STAC_Score_Avg',3,7,'float',8,'Average STAC score (Confidence score)')
INSERT INTO [T_SP_Glossary] VALUES (34,'SLiC_or_STAC_Score_Avg',3,7,'float',8,'Average STAC or Average SLiC score (mix of both because source data uses a mix of both scores)')
...
INSERT INTO [T_SP_Glossary] VALUES (34,'Internal_Std_Count_Unique_Observed',3,9,'int',4,'Unique number of internal standard peptides identified for the given protein.')
INSERT INTO [T_SP_Glossary] VALUES (34,'Peptide_Count_Used_For_Abundance',3,10,'int',4,'Unique number of peptides whose abundance values were averaged together to compute the protein abundance value.  The column "Used For Abundance Computation" in the peptide results list will have a value of 1 for all peptides included in the averaging.')
INSERT INTO [T_SP_Glossary] VALUES (34,'MT_Count_Unique_Observed_Both_MS_and_MSMS',3,11,'int',4,'Unique number of PMTs (peptides) observed by both MS and MS/MS for this dataset')
INSERT INTO [T_SP_Glossary] VALUES (34,'Full_Enzyme_Count',3,12,'int',4,'Number of fully tryptic PMTs identified for the given protein.')
INSERT INTO [T_SP_Glossary] VALUES (34,'Potential_Full_Enzyme_Count',3,13,'int',4,'Number of fully tryptic PMTs in the PMT tag database for the given protein.  This is not the number identified by LC-FTICR-MS; rather, it is the number putatively identified by LC-MS/MS and thus the total number that could possibly be identified by LC-FTICR-MS.')
INSERT INTO [T_SP_Glossary] VALUES (34,'Full_Enzyme_No_Missed_Cleavage_Count',3,14,'int',4,'Number of fully tryptic PMTs with no missed cleavages identified for the given protein.')
INSERT INTO [T_SP_Glossary] VALUES (34,'Partial_Enzyme_Count',3,15,'int',4,'Number of partially tryptic PMTs identified for the given protein.')
INSERT INTO [T_SP_Glossary] VALUES (34,'Potential_Partial_Enzyme_Count',3,16,'int',4,'Number of partially tryptic PMTs in the PMT tag database for the given protein.  This is not the number identified by LC-FTICR-MS; rather, it is the number putatively identified by LC-MS/MS and thus the total number that could possibly be identified by LC-FTICR-MS.')
INSERT INTO [T_SP_Glossary] VALUES (34,'ORF_Coverage_Residue_Count',3,17,'int',4,'Number of residues for the given protein (ORF) that were matched, when considering all of the PMTs (peptides) that were matched for this protein.')
INSERT INTO [T_SP_Glossary] VALUES (34,'Potential_Protein_Coverage_Residue_Count',3,18,'int',4,'Potential number of residues for the given protein (ORF) that could be matched, if all PMTs in the PMT tag database for the given protein were identified.  This is not the number of residues identified by LC-FTICR-MS; rather, it is the number putatively identified by LC-MS/MS and thus the total number that could possibly be identified by LC-FTICR-MS.')
INSERT INTO [T_SP_Glossary] VALUES (34,'Protein_Coverage_Percent',3,19,'decimal',5,'Residue-based coverage (percent) for the given protein, when considering all of the PMTs (peptides) that were matched for this protein.')
INSERT INTO [T_SP_Glossary] VALUES (34,'Potential_Protein_Coverage_Percent',3,20,'decimal',5,'Potential residue-based coverage (percent) for the given protein, if all PMTs in the PMT tag database for the given protein were identified.  This is not the percent coverage identified by LC-FTICR-MS; rather, it is the coverage based on the peptides putatively identified by LC-MS/MS and thus the highest coverage that could possibly be achived using LC-FTICR-MS.')
INSERT INTO [T_SP_Glossary] VALUES (34,'Protein_Coverage_Percent_High_Abundance',3,21,'decimal',5,'Residue-based coverage (percent) for the given protein, when considering all of the high abundance PMTs (peptides) that were matched for this protein.  The high abundance peptides have a value of 1 in the "Used For Abundance Computation" column in the peptide results list.')
INSERT INTO [T_SP_Glossary] VALUES (34,'Protein_Count_Avg',3,22,'decimal',5,'Average Protein_Count value for all PMTs (peptides) identified for the given protein.  If all of the peptides'' sequences are only present in this protein''s sequence, then Average Protein_Count is 1.')
INSERT INTO [T_SP_Glossary] VALUES (34,'Mass_Tag_ID',3,23,'int',4,'Unique integer identification number for the given PMT (peptide).')
INSERT INTO [T_SP_Glossary] VALUES (34,'Mass_Tag_Mods',3,24,'varchar',50,'Amino acid residue modifications associated with the given PMT (peptide).')
INSERT INTO [T_SP_Glossary] VALUES (34,'MT_Abundance',3,25,'float',8,'Abundance of the PMT (peptide).  Computed using the area under the chromatographic peak for the UMC that matched the given PMT.  If the PMT was matched by several UMCs, then this is the sum of the abundances for the matching UMCs.')
INSERT INTO [T_SP_Glossary] VALUES (34,'MT_Abundance_StDev',3,26,'float',8,'Standard deviation of the PMT abundance.')
INSERT INTO [T_SP_Glossary] VALUES (34,'Member_Count_Used_For_Abundance',3,27,'decimal',5,'Number of data points (scans) within the UMC that were summed to compute the abundance for the given UMC.')
INSERT INTO [T_SP_Glossary] VALUES (34,'MT_SLiC_Score',3,28,'float',8,'Spatially Localized Confidence Score (SLiC Score).  This score represents the uniqueness of the given PMT matching the associated UMC.  If the associated UMC only matched one PMT, then MT_SLiC_Score will be 1.  If it matched two PMTs, but one was much closer in mass and NET than the second, then the first could have a SLiC score of 0.8 and the second a score of 0.2')
INSERT INTO [T_SP_Glossary] VALUES (34,'MT_STAC_Score',3,29,'float',8,'STAC score (Confidence score).  Scores closer to 1 are higher confidence.')
INSERT INTO [T_SP_Glossary] VALUES (34,'MT_STAC_or_SLiC_Score',3,30,'float',8,'STAC or Average SLiC score (mix of both because source data uses a mix of both types of peak matching)')
INSERT INTO [T_SP_Glossary] VALUES (34,'MT_Del_SLiC',3,31,'float',8,'Difference in SLiC score between this PMT and the highest scoring PMT matching the UMC that identified this PMT.  If this was the highest confidence PMT match for the given UMC, then MT_Del_SLiC = 0.  This value will be the average of several values if replicate results are rolled up.')
INSERT INTO [T_SP_Glossary] VALUES (34,'MT_Del_STAC',3,32,'float',8,'Difference in STAC score between this PMT and the highest scoring PMT matching the UMC that identified this PMT.  If this was the highest confidence PMT match for the given UMC, then MT_Del_STAC = 0.  This value will be the average of several values if replicate results are rolled up.')
INSERT INTO [T_SP_Glossary] VALUES (34,'MT_Del_STAC_or_SLiC',3,33,'float',8,'Difference in STAC or SLiC score (mix of both because source data uses a mix of both types of peak matching)')
INSERT INTO [T_SP_Glossary] VALUES (34,'MT_Uniqueness_Probability',3,34,'float',8,'Uniqueness Probability (UP) score.  This score represents the uniqueness of the given PMT matching the associated UMC.  If the associated UMC only matched one PMT, then MT_Uniqueness_Probability will be 1.  If it matched two PMTs, but one was much closer in mass and NET than the second, then the first could have MT_Uniqueness_Probability of 0.8 and the second a MT_Uniqueness_Probability of 0.2')
INSERT INTO [T_SP_Glossary] VALUES (34,'MT_FDR_Threshold',3,35,'float',8,'FDR threshold value associated with the given STAC score')
INSERT INTO [T_SP_Glossary] VALUES (34,'Peptide',3,36,'varchar',850,'Sequence of the PMT (peptide)')
INSERT INTO [T_SP_Glossary] VALUES (34,'Monoisotopic_Mass',3,37,'float',8,'Uncharged mass of the PMT.')
INSERT INTO [T_SP_Glossary] VALUES (34,'High_MS/MS_Score_(XCorr)',3,38,'real',4,'Highest MS/MS fragmentation spectrum identification score observed for the given PMT (peptide).  This is typically the highest Sequest XCorr value observed.')
INSERT INTO [T_SP_Glossary] VALUES (34,'High_Discriminant_Score',3,39,'real',4,'Highest discriminant score computed for the given PMT (peptide).  Discriminant scores are based on LC-MS/MS observations.')
INSERT INTO [T_SP_Glossary] VALUES (34,'High_Peptide_Prophet_Probability',3,40,'real',4,'Highest peptide prophet probability computed for the given PMT (peptide).  Peptide prophet values are based on LC-MS/MS observations.')
INSERT INTO [T_SP_Glossary] VALUES (34,'XTandem_Min_Log_EValue',3,41,'real',4,'Lowest X!Tandem Log(E_Value) observed for the given PMT (peptide).')
INSERT INTO [T_SP_Glossary] VALUES (34,'PMT_Quality_Score',3,42,'decimal',5,'Rough indication of the confidence of the PMT identity based on LC-MS/MS data.  This value is typically 0, 1, or 2, with 0 being low confidence, 1 being higher, and 2 being the highest.  The confidence is based on XCorr and DelCn cutoff values that vary from database to database.')
INSERT INTO [T_SP_Glossary] VALUES (34,'JobCount_Observed_Both_MS_and_MSMS',3,43,'int',4,'Number of jobs in which this PMT (peptide) was observed by both MS and MS/MS')
INSERT INTO [T_SP_Glossary] VALUES (34,'Protein_Count',3,44,'tinyint',1,'Number of proteins that the given PMT (peptide) is present in (aka protein or ORF degeneracy).  If the peptide sequence is only present in one protein''s sequence, then Protein_Count = 1.  If the peptide sequence is present in two proteins'' sequences, then Protein_Count = 2.')
INSERT INTO [T_SP_Glossary] VALUES (34,'Cleavage_State_Name',3,45,'varchar',50,'The enzymatic cleavage state for the given PMT (peptide), in the context of the given protein.')
INSERT INTO [T_SP_Glossary] VALUES (34,'UMC_MatchCount',3,46,'decimal',5,'Number of UMCs that matched the given PMT.  If replicate or fractionated datasets are rolled up in this Q Rollup, then this is the average of the UMC match count for each.')
INSERT INTO [T_SP_Glossary] VALUES (34,'Scan_Minimum',3,47,'int',4,'Ending scan number of the UMCs that matched the given PMT (peptide).')
INSERT INTO [T_SP_Glossary] VALUES (34,'Scan_Maximum',3,48,'int',4,'Ending scan number of the UMCs that matched the given PMT (peptide).')
INSERT INTO [T_SP_Glossary] VALUES (34,'NET_Minimum',3,49,'decimal',5,'Minimum NET for the UMC matching this PMT.  If only one dataset is included in the rollup, then NET_Minimum will be the same as NET_Maximum.  If more than one dataset is rolled up, then this is the minimum NET of all UMCs that matched the given PMT.')
INSERT INTO [T_SP_Glossary] VALUES (34,'NET_Maximum',3,50,'decimal',5,'Maximum NET for the UMC matching this PMT.  If only one dataset is included in the rollup, then NET_Maximum will be the same as NET_Minimum.  If more than one dataset is rolled up, then this is the maximum NET of all UMCs that matched the given PMT.')
INSERT INTO [T_SP_Glossary] VALUES (34,'Charge_Basis',3,51,'decimal',5,'The primary charge state associated with the UMC that matched the given PMT.  If several UMCs led to this identification, then this is the average of the primary charge states for each.  If replicate or fractionated datasets are rolled up in this Q Rollup, then this is the average of the primary charge states for each.')
INSERT INTO [T_SP_Glossary] VALUES (34,'Charge_State_Min',3,52,'tinyint',1,'The minimum charge state associated with the UMC(s) that matched the given PMT.')
INSERT INTO [T_SP_Glossary] VALUES (34,'Charge_State_Max',3,53,'tinyint',1,'The maximum charge state associated with the UMC(s) that matched the given PMT.')
INSERT INTO [T_SP_Glossary] VALUES (34,'MT_Mass_Error_PPM',3,54,'decimal',5,'Mass difference, in ppm, between the UMC''s median mass and the PMT''s theoretical monoisotopic mass.  This value will be the average of several values if replicate results are rolled up.')
INSERT INTO [T_SP_Glossary] VALUES (34,'NET_Error_Obs',3,55,'decimal',5,'NET difference between the UMC''s median NET and the PMT''s observed NET.  This value will be the average of several values if replicate results are rolled up.')
INSERT INTO [T_SP_Glossary] VALUES (34,'NET_Error_Pred',3,56,'decimal',5,'NET difference between the UMC''s median NET and the PMT''s predicted NET.  The predicted NET is different than the observed NET for a PMT since the observed NET is the average observed elution time for the peptide while the predicted NET is the elution time predicted by a trained prediction model.  This value will be the average of several values if replicate results are rolled up.')
INSERT INTO [T_SP_Glossary] VALUES (34,'Used_For_Abundance_Computation',3,57,'tinyint',1,'Will be 1 if the given PMT (peptide) was included in the group of PMTs whose abundance values were averaged together to compute the protein abundance value for the protein associated with this PMT.')
...
INSERT INTO [T_SP_Glossary] VALUES (35,'VerboseColumnOutput',1,7,'tinyint',1,null)
...
INSERT INTO [T_SP_Glossary] VALUES (35,'STAC_Score_Avg',3,7,'float',8,'Average STAC score (Confidence score). Scores closer to 1 are higher confidence.')
INSERT INTO [T_SP_Glossary] VALUES (35,'SLiC_or_STAC_Score_Avg',3,7,'float',8,'Average STAC or Average SLiC score (mix of both because source data uses a mix of both types of peak matching)')
...
INSERT INTO [T_SP_Glossary] VALUES (35,'Internal_Std_Count_Unique_Observed',3,9,'int',4,'Unique number of internal standard peptides identified for the given protein.')
INSERT INTO [T_SP_Glossary] VALUES (35,'Peptide_Count_Used_For_Abundance',3,10,'int',4,'Unique number of peptides whose abundance values were averaged together to compute the protein abundance value.  The column "Used For Abundance Computation" in the peptide results list will have a value of 1 for all peptides included in the averaging.')
INSERT INTO [T_SP_Glossary] VALUES (35,'MT_Count_Unique_Observed_Both_MS_and_MSMS',3,11,'int',4,'Unique number of PMTs (peptides) observed by both MS and MS/MS for this dataset')
INSERT INTO [T_SP_Glossary] VALUES (35,'Full_Enzyme_Count',3,12,'int',4,'Number of fully tryptic PMTs identified for the given protein.')
INSERT INTO [T_SP_Glossary] VALUES (35,'Potential_Full_Enzyme_Count',3,13,'int',4,'Number of fully tryptic PMTs in the PMT tag database for the given protein.  This is not the number identified by LC-FTICR-MS; rather, it is the number putatively identified by LC-MS/MS and thus the total number that could possibly be identified by LC-FTICR-MS.')
INSERT INTO [T_SP_Glossary] VALUES (35,'Full_Enzyme_No_Missed_Cleavage_Count',3,14,'int',4,'Number of fully tryptic PMTs with no missed cleavages identified for the given protein.')
INSERT INTO [T_SP_Glossary] VALUES (35,'Partial_Enzyme_Count',3,15,'int',4,'Number of partially tryptic PMTs identified for the given protein.')
INSERT INTO [T_SP_Glossary] VALUES (35,'Potential_Partial_Enzyme_Count',3,16,'int',4,'Number of partially tryptic PMTs in the PMT tag database for the given protein.  This is not the number identified by LC-FTICR-MS; rather, it is the number putatively identified by LC-MS/MS and thus the total number that could possibly be identified by LC-FTICR-MS.')
INSERT INTO [T_SP_Glossary] VALUES (35,'ORF_Coverage_Residue_Count',3,17,'int',4,'Number of residues for the given protein (ORF) that were matched, when considering all of the PMTs (peptides) that were matched for this protein.')
INSERT INTO [T_SP_Glossary] VALUES (35,'Potential_Protein_Coverage_Residue_Count',3,18,'int',4,'Potential number of residues for the given protein (ORF) that could be matched, if all PMTs in the PMT tag database for the given protein were identified.  This is not the number of residues identified by LC-FTICR-MS; rather, it is the number putatively identified by LC-MS/MS and thus the total number that could possibly be identified by LC-FTICR-MS.')
INSERT INTO [T_SP_Glossary] VALUES (35,'Protein_Coverage_Percent',3,19,'decimal',5,'Residue-based coverage (percent) for the given protein, when considering all of the PMTs (peptides) that were matched for this protein.')
INSERT INTO [T_SP_Glossary] VALUES (35,'Potential_Protein_Coverage_Percent',3,20,'decimal',5,'Potential residue-based coverage (percent) for the given protein, if all PMTs in the PMT tag database for the given protein were identified.  This is not the percent coverage identified by LC-FTICR-MS; rather, it is the coverage based on the peptides putatively identified by LC-MS/MS and thus the highest coverage that could possibly be achived using LC-FTICR-MS.')
INSERT INTO [T_SP_Glossary] VALUES (35,'Protein_Coverage_Percent_High_Abundance',3,21,'decimal',5,'Residue-based coverage (percent) for the given protein, when considering all of the high abundance PMTs (peptides) that were matched for this protein.  The high abundance peptides have a value of 1 in the "Used For Abundance Computation" column in the peptide results list.')
INSERT INTO [T_SP_Glossary] VALUES (35,'Protein_Count_Avg',3,22,'decimal',5,'Average Protein_Count value for all PMTs (peptides) identified for the given protein.  If all of the peptides'' sequences are only present in this protein''s sequence, then Average Protein_Count is 1.')
INSERT INTO [T_SP_Glossary] VALUES (35,'Mono_Mass_KDa',3,23,'float',8,'Uncharged mass of the protein.')
...
INSERT INTO [T_SP_Glossary] VALUES (36,'VerboseColumnOutput',1,4,'tinyint',1,null)
...
INSERT INTO [T_SP_Glossary] VALUES (36,'MDIDs',3,6,'varchar',1024,'List of Match Making IDs (MDIDs) used to create the rollup')
INSERT INTO [T_SP_Glossary] VALUES (36,'Results Folder Path',3,7,'varchar',255,'Location of folder containg the graphics and chromatograms of the peak matching results.')
INSERT INTO [T_SP_Glossary] VALUES (36,'Threshold For Inclusion (%Max)',3,8,'decimal',5,'Decimal value to multiply the abundance value of the most abundant peptide for each protein by when determining the cutoff to use for choosing peptides to average together to compute average protein abundances.  Typically 0.33')
INSERT INTO [T_SP_Glossary] VALUES (36,'Feature (UMC) Count',3,9,'int',4,'Number of features (UMCs) observed in the dataset used for peak matching.')
INSERT INTO [T_SP_Glossary] VALUES (36,'Feature Count With Hits',3,10,'int',4,'Number of features (UMCs) in the given Q rollup that had one or more matching PMT tags.')
INSERT INTO [T_SP_Glossary] VALUES (36,'Percent Features With Hits',3,11,'int',4,'Percent of features (UMCs) in the given Q rollup that had one or more matching PMT tags.')
INSERT INTO [T_SP_Glossary] VALUES (36,'Unique PMT Tag Count Matched',3,12,'int',4,'Unique number of PMT tags (peptides) identified in the given Q rollup.')
INSERT INTO [T_SP_Glossary] VALUES (36,'Unique Internal Std Count Matched',3,13,'int',4,'Unique number of internal standard peptides identified in the given Q rollup.')
INSERT INTO [T_SP_Glossary] VALUES (36,'Comparison PMT Tag Count',3,14,'int',4,'Number of PMT tags (peptides) that the UMCs were compared against in the peak matching task(s) included in the given Q Rollup.  If more than one peak matching tasks are rolled up, then this is an average for all tasks included, though the number of PMTs used will typically be the same for all tasks included in a single rollup.')
INSERT INTO [T_SP_Glossary] VALUES (36,'AMTs 1% FDR',3,15,'real',4,'Unique number of PMT tags (peptides) that were identified with 1% FDR or better')
INSERT INTO [T_SP_Glossary] VALUES (36,'AMTs 2.5% FDR',3,16,'real',4,'Unique number of PMT tags (peptides) that were identified with 2.5% FDR or better')
INSERT INTO [T_SP_Glossary] VALUES (36,'AMTs 5% FDR',3,17,'real',4,'Unique number of PMT tags (peptides) that were identified with 5% FDR or better')
INSERT INTO [T_SP_Glossary] VALUES (36,'AMTs 10% FDR',3,18,'real',4,'Unique number of PMT tags (peptides) that were identified with 10% FDR or better')
INSERT INTO [T_SP_Glossary] VALUES (36,'AMTs 25% FDR',3,19,'real',4,'Unique number of PMT tags (peptides) that were identified with 25% FDR or better')
INSERT INTO [T_SP_Glossary] VALUES (36,'AMTs 50% FDR',3,20,'real',4,'Unique number of PMT tags (peptides) that were identified with 50% FDR or better')
INSERT INTO [T_SP_Glossary] VALUES (36,'UMC Tolerance PPM',3,21,'numeric',5,'Tolerance used when grouping data points into UMCs in the dataset used for peak matching.')
INSERT INTO [T_SP_Glossary] VALUES (36,'NetAdj NET Min',3,22,'numeric',5,'Minimum NET value in the dataset used for peak matching.')
INSERT INTO [T_SP_Glossary] VALUES (36,'NetAdj NET Max',3,23,'numeric',5,'Maximum NET value in the dataset used for peak matching.')
INSERT INTO [T_SP_Glossary] VALUES (36,'MMA TolerancePPM',3,24,'numeric',5,'Mass tolerance (in ppm) used during peak matching when matching UMCs to PMTs.')
INSERT INTO [T_SP_Glossary] VALUES (36,'NET Tolerance',3,25,'numeric',5,'Normalized elution time tolerance used during peak matching when matching UMCs to PMTs.')
INSERT INTO [T_SP_Glossary] VALUES (36,'Refine Mass Cal PPM Shift',3,26,'numeric',5,'Mass correction factor applied to the UMC masses during peak matching to correct for systematic calibration error in the dataset.')
INSERT INTO [T_SP_Glossary] VALUES (36,'Total Scans Avg',3,27,'int',4,'Average number of scans in which peptide was seen')
INSERT INTO [T_SP_Glossary] VALUES (36,'Scan Start',3,28,'int',4,'Initial scan number in the dataset used for peak matching.')
INSERT INTO [T_SP_Glossary] VALUES (36,'Scan End',3,29,'int',4,'Final scan number in the dataset used for peak matching.')
INSERT INTO [T_SP_Glossary] VALUES (36,'Match Score Mode',3,30,'tinyint',2,'Match Score Mode: 0 = SLiC score; 1 = STAC Score')
INSERT INTO [T_SP_Glossary] VALUES (36,'Replicate Normalization Stats',3,31,'varchar',1024,'Summary of the normalization steps applied for replicate-based Q Rollups.')
INSERT INTO [T_SP_Glossary] VALUES (37,'DBName',1,1,'varchar',128,null)
INSERT INTO [T_SP_Glossary] VALUES (37,'DBType',2,2,'tinyint',1,null)
INSERT INTO [T_SP_Glossary] VALUES (37,'DBSchemaVersion',2,3,'real',4,null)
INSERT INTO [T_SP_Glossary] VALUES (37,'DBID',2,4,'int',4,null)
INSERT INTO [T_SP_Glossary] VALUES (37,'message',2,5,'varchar',256,null)
INSERT INTO [T_SP_Glossary] VALUES (39,'DBName',1,1,'varchar',128,null)
INSERT INTO [T_SP_Glossary] VALUES (39,'outputColumnNameList',1,2,'varchar',2048,null)
INSERT INTO [T_SP_Glossary] VALUES (39,'criteriaSql',1,3,'varchar',6000,null)
INSERT INTO [T_SP_Glossary] VALUES (39,'returnRowCount',1,4,'varchar',32,null)
INSERT INTO [T_SP_Glossary] VALUES (39,'pepIdentMethod',1,6,'varchar',32,null)
INSERT INTO [T_SP_Glossary] VALUES (39,'message',2,5,'varchar',512,null)
INSERT INTO [T_SP_Glossary] VALUES (40,'DBName',1,1,'varchar',128,null)
INSERT INTO [T_SP_Glossary] VALUES (40,'DBSchemaVersion',2,2,'real',4,null)
INSERT INTO [T_SP_Glossary] VALUES (40,'message',2,3,'varchar',256,null)
INSERT INTO [T_SP_Glossary] VALUES (41,'DBName',1,1,'varchar',128,null)
INSERT INTO [T_SP_Glossary] VALUES (41,'outputColumnNameList',1,2,'varchar',2048,null)
INSERT INTO [T_SP_Glossary] VALUES (41,'criteriaSql',1,3,'varchar',6000,null)
INSERT INTO [T_SP_Glossary] VALUES (41,'returnRowCount',1,4,'varchar',32,null)
INSERT INTO [T_SP_Glossary] VALUES (41,'message',2,5,'varchar',512,null)
