/****** Object:  StoredProcedure [dbo].[AddUpdateQuantitationDescription] ******/
SET ANSI_NULLS ON
GO
...
GO
GRANT EXECUTE ON [dbo].[AddUpdateQuantitationDescription] TO [DMS_SP_User] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[AddUpdateQuantitationDescription] TO [MTS_DB_Dev] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[AddUpdateQuantitationDescription] TO [MTS_DB_Lite] AS [dbo]
GO
