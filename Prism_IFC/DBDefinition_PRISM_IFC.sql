...
CREATE DATABASE [PRISM_IFC]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'PRISM_IFC_Data', FILENAME = N'J:\SQLServerData\PRISM_IFC_Data.mdf' , SIZE = 11648KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
 LOG ON 
( NAME = N'PRISM_IFC_Log', FILENAME = N'L:\SQLServerData\PRISM_IFC_Log.ldf' , SIZE = 7616KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
...
GO
ALTER DATABASE [PRISM_IFC] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [PRISM_IFC] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
ALTER DATABASE [PRISM_IFC] SET DELAYED_DURABILITY = DISABLED 
GO
USE [PRISM_IFC]
GO
/****** Object:  User [D3E383] ******/
