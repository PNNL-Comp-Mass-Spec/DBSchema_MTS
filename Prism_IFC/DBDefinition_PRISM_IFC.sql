...
( NAME = N'PRISM_IFC_Data', FILENAME = N'F:\SQLServerData\Prism_IFC_data.mdf' , SIZE = 6976KB , MAXSIZE = UNLIMITED, FILEGROWTH = 80KB )
 LOG ON 
( NAME = N'PRISM_IFC_Log', FILENAME = N'F:\SQLServerData\Prism_IFC_log.ldf' , SIZE = 1280KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
