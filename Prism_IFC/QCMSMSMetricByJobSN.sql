...
**
**	Desc: 
**	Uses @SeqIDList and @MetricID to return a metric value representing signal to noise ratio (S/N)
...
As
	...
	Exec PostUsageLogEntry 'QCMSMSMetricByJobSN', @DBName, @UsageMessage	
...
GO
GRANT VIEW DEFINITION ON [dbo].[QCMSMSMetricByJobSN] TO [MTS_DB_Dev] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[QCMSMSMetricByJobSN] TO [MTS_DB_Lite] AS [dbo]
GO
