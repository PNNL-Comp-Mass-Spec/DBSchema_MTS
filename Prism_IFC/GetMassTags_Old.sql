/****** Object:  StoredProcedure [dbo].[GetMassTags_Old] ******/
SET ANSI_NULLS ON
GO
...
GO
GRANT EXECUTE ON [dbo].[GetMassTags_Old] TO [DMS_SP_User] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[GetMassTags_Old] TO [MTS_DB_Dev] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[GetMassTags_Old] TO [MTS_DB_Lite] AS [dbo]
GO
