/****** Object:  StoredProcedure [dbo].[GetAnalysisJobToPeptideDBMap] ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

CREATE PROCEDURE dbo.GetAnalysisJobToPeptideDBMap
/****************************************************
**
**	Desc: Return list of analysis jobs present in Peptide DBs on the various MTS servers
**        
...
As	
	...
	Exec @myError = GetAnalysisJobToDBMap 2, @SummaryList, @IncludeDMSInfo, @JobMinimum, @JobMaximum, @DBNameFilter, @ServerFilter, @MaximumRowCount, @message = @message output
