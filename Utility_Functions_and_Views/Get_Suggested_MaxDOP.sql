 ...
 *
 * Updated by Matthew Monroe in 2017
 *
 * Also consider using dbaTools
 * Clone from https://github.com/sqlcollaborative/dbatools/
 * Next start Powershell, and run these commands:
 * .\Install.ps1
 * Import-Module C:\DMS_Programs\dbatools\dbatools.psd1
 * Test-DbaMaxDop -SqlServer Server1, Server2, Server3 | Format-Table -autoSize -Wrap
 *
 */
...
Updated 2017-03-14 :  Matthew Monroe, adding @Divisor float = @physicalCPU / @NoOfNUMA
