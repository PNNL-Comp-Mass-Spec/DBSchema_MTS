/*
 * From https://www.simple-talk.com/blogs/2016/03/07/sql-server-table-smells/
 * by Phil Factor
 */
...
SELECT Replace(TableName, 'dbo.','') AS TableName,
