if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[udfTimeStampText]') and xtype in (N'FN', N'IF', N'TF'))
drop function [dbo].[udfTimeStampText]
GO
...
CREATE FUNCTION dbo.udfTimeStampText
/****************************************************	
